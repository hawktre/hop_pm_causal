...
#Import my MLEs
stan_mles = pd.read_csv("results/mle/mle_results.csv")
stan_preds = pd.read_csv("results/mle/mle_preds.csv")
...
for month in months:
    ...
    for t, year in enumerate(years):
        ...
        edge_csv_path = f"results/mle/edge_weights/edge_weights_{month}_seperate_mle_{year}.csv"
...
seperate_preds.to_csv("results/mle/seperate_mle_preds.csv", index=False)
seperate_edges.to_csv("results/mle/seperate_mle_edges_long.csv", index=False)
